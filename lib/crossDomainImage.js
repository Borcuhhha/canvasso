...
var CrossDomainImage = {
	create: function create(urlOrImage, callback) {
	...
	createImages: function createImages(urlOrImageArray, callback) {
  ...
  */
	setProxyURL: function setProxyURL(url, argname, shouldencoding) {
		if (parseHostname(url) !== hostname) {
...
exports.default = CrossDomainImage;